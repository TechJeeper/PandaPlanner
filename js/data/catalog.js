(function (global) {
    ...
    PP.CATALOG = {
        ...
        accessories: [
            ...
            { id: 'popstation_mini', name: 'BIQU PopStation Mini', price: 179.99, link: 'https://biqu.equipment/products/biqu-popstation-mini-sealed-dual-drawer-storage-cabinet-for-4-filament-spools', desc: 'Sealed dual-drawer storage cabinet for 4 filament spools for Snapmaker U1.', compat: ['snapmaker_u1'], slot: 'filament_storage', category: 'upgrade', group: 'snapmaker', photo: '' },
