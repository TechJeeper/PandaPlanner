(function (global) {
    ...
    PP.CATALOG = {
        ...
        accessories: [
            ...
            { id: 'popstation_mini', name: 'BIQU PopStation Mini', price: 179.99, link: 'https://biqu.equipment/products/biqu-popstation-mini-sealed-dual-drawer-storage-cabinet-for-4-filament-spools', desc: 'Sealed dual-drawer storage cabinet for 4 filament spools for Snapmaker U1. Sits on the floor beside the printer.', compat: ['snapmaker_u1'], slot: 'filament_storage', category: 'upgrade', group: 'snapmaker', role: 'side', photo: '' },
            { id: 'popstation_mini_wheels', name: 'PopStation Mini Wheels', price: 0, link: 'https://biqu.equipment/products/biqu-popstation-mini-sealed-dual-drawer-storage-cabinet-for-4-filament-spools', desc: 'Caster-wheel option for moving a PopStation Mini beside a Snapmaker U1.', compat: ['snapmaker_u1'], slot: 'popstation_wheels', category: 'upgrade', group: 'snapmaker', requiresPopstationMini: true, photo: '' },
